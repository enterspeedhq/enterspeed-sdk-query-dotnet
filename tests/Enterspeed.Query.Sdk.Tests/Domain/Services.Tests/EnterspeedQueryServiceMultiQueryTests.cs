    ...
    public EnterspeedQueryServiceMultiQueryTests()
    {
                ...
                new
                {
                    ...
                    facets = new[]
                    {
                        new
                        {
                            ...
                            groups = new[]
                            {
                                new { value = "Shoes", count = 15 },
                                new { value = "Accessories", count = 5 }
                            },
                            isValid = true
                        }
                    }
                ...
                new
                {
                    ...
                    facets = new[]
                    {
                        new
                        {
                            ...
                            groups = new[]
                            {
                                new { value = "Caps", count = 8 },
                                new { value = "Hoodies", count = 2 }
                            },
                            isValid = true
                        },
                        new
                        {
                            ...
                            groups = new[]
                            {
                                new { value = "S", count = 15 },
                                new { value = "M", count = 25 },
                                new { value = "L", count = 20 }
                            },
                            isValid = true
                        }
                    }
        ...
        public async Task SingleQuery_WithValidRequest_ReturnsSuccess()
        {
            ...
            var mockResponse = new QueryResponseSuccess
            {
                ...
                {
                    new() { { "sku", "p-001" }, { "name", "Product 1" } },
                    new() { { "sku", "p-002" }, { "name", "Product 2" } }
                },
                Facets = new List<FacetResult>
                {
                    new()
                    {
                        ...
                        {
                            new() { Value = "Electronics", Count = 15 },
                            new() { Value = "Books", Count = 8 }
                        }
                    }
                }
            };
        ...
        public async Task SingleQuery_WithInvalidRequest_ReturnsBadRequest()
        {
            ...
            var mockResponse = new Dictionary<string, object>
            {
                ...
                { "errors", new List<string> { "Field not found: invalidField" } },
                { "status", 1 }
            };
            ...
            var query = new QueryObject
            {
                Sort = new List<Sort> { new() { Field = "invalidField", Order = SortOrder.Desc } },
                Pagination = new Pagination { Page = 0, PageSize = 10 }
            };
            ...
            result.Response.Should().BeNull("single query API returns null Response on BadRequest");
        }
        ...
        public async Task MultiQuery_WithAllErrorResponses_ReturnsErrorStatus()
        {
            ...
            var apiResponse = new List<object>
            {
                new
                {
                    ...
                    status = 1,
                    message = "Index not found",
                    errors = new[] { "The specified index 'invalid-index-1' does not exist" }
                },
                new
                {
                    ...
                    errors = new[] { "You don't have permission to access this index" }
                }
            };
